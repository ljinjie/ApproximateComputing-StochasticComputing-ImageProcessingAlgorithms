...
if __name__ == '__main__':
    # in_image1_name = r'Design Set 1 Results\conv_contrast_stretching\CS_S1_0_bits_truncated.jpg'
    # in_image2_name = r'Design Set 2 Results\stoch_contrast_stretching\Fixed SN Length\CS_S2_correlation_0_bits_truncated.jpg'
    # in_image3_name = r'Design Set 3 Results\hybrid_contrast_stretching_perm\perm_CS_S3_5_stochastic_bits.jpg'

    in_image1_name = 'CS_S1_0_bits_truncated.jpg'
    in_image2_name = 'CS_S1_0_bits_truncated_ideal_hybrid.jpg'
    in_image3_name = 'perm_CS_S3_4_stochastic_bits.jpg'
    ...
    print('Fixed SN length in S2, 3 stoch bits in S3:')
    print('\n')
    ...
    in_image2_name = r'Design Set 2 Results\stoch_contrast_stretching\Dynamic SN Length\CS_S2_correlation_0_bits_truncated.jpg'
    in_image3_name = r'Design Set 3 Results\hybrid_contrast_stretching_perm\perm_CS_S3_5_stochastic_bits.jpg'
    ...
    print('Dynamic SN length in S2, 5 stoch bits in S3:')
    print('\n')
    mse_i2, mse_i3 = find_mse(image1, image2, image3)
    print('\tMSE of pure stochastic: ' + str(mse_i2))
    print('\tMSE of hybrid: ' + str(mse_i3))
