...
if __name__ == '__main__':
    in_image1_name = 'Design Set 1 Results\conv_edge_detection\ED_S1_0_bits_truncated.jpg'
    in_image2_name = 'Design Set 2 Results\stoch_edge_detection\Fixed SN Length\ED_S2_correlation_1_bits_truncated.jpg'
    in_image3_name = 'Design Set 3 Results\hybrid_edge_detection_perm\perm_ED_S3_5_stochastic_bits_subtraction.jpg'
    ...
    print('Fixed SN length in S2, Subtraction in S3:')
    print('\n')
    ...
    in_image2_name = 'Design Set 2 Results\stoch_edge_detection\Dynamic SN Length\ED_S2_correlation_1_bits_truncated.jpg'
    in_image3_name = 'Design Set 3 Results\hybrid_edge_detection_perm\perm_ED_S3_5_stochastic_bits_addition.jpg'
    ...
    print('Dynamic SN length in S2, Addition in S3:')
    print('\n')
    mse_i2, mse_i3 = find_mse(image1, image2, image3)
    print('\tMSE of pure stochastic: ' + str(mse_i2))
    print('\tMSE of hybrid: ' + str(mse_i3))
