...
if __name__ == '__main__':
    in_image1_name = r'Design Set 1 Results\conv_frame_difference_small\FD_S1_0_bits_truncated.jpg'
    in_image2_name = r'Design Set 2 Results\stoch_frame_difference_correlation_no_parallel_fsm\Fixed SN Length\FD_S2_correlation_1_bits_truncated.jpg'
    in_image3_name = r'Design Set 3 Results\hybrid_frame_difference_perm\perm_FD_S3_3_stochastic_bits.jpg'
    in_image2_name = in_image3_name
    #
    # in_image1_name = 'FD_S1_0_bits_truncated.jpg'
    # in_image2_name = 'perm_FD_S3_4_stochastic_bits.jpg'
    # in_image3_name = 'perm_FD_S3_4_stochastic_bits.jpg'
    # in_image2_name = in_image3_name
    ...
    print('Fixed SN length in S2, 4 stoch bits in S3:')
    print('\n')
